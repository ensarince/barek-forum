...
const PREVIEW_TOPICS: TopicWithMeta[] = [
  { id: 't1', title: 'Ana Duvar yeni güzergah önerisi', content: '', author_id: 'u1', sector_id: '1', type: 'discussion', status: 'pending', is_pinned: false, approved_by: null, approved_at: null, created_at: new Date(Date.now() - 3600000).toISOString(), updated_at: new Date(Date.now() - 3600000).toISOString(), author: { username: 'taş_tırmanan', avatar_url: null }, sector: { name: 'Ana Duvar' } },
  { id: 't2', title: 'Mağara Sektörü beta sorusu', content: '', author_id: 'u2', sector_id: '2', type: 'discussion', status: 'pending', is_pinned: false, approved_by: null, approved_at: null, created_at: new Date(Date.now() - 7200000).toISOString(), updated_at: new Date(Date.now() - 7200000).toISOString(), author: { username: 'kaya_kemal', avatar_url: null }, sector: { name: 'Mağara Sektörü' } },
  { id: 't3', title: 'Sezon açılışı hakkında', content: '', author_id: 'u4', sector_id: null, type: 'announcement', status: 'approved', is_pinned: true, approved_by: 'admin', approved_at: new Date(Date.now() - 86400000).toISOString(), created_at: new Date(Date.now() - 86400000).toISOString(), updated_at: new Date(Date.now() - 86400000).toISOString(), author: { username: 'murat_b', avatar_url: null }, sector: null },
  { id: 't4', title: 'Bouldering matı tavsiyesi', content: '', author_id: 'u5', sector_id: '1', type: 'discussion', status: 'approved', is_pinned: false, approved_by: 'admin', approved_at: new Date(Date.now() - 172800000).toISOString(), created_at: new Date(Date.now() - 172800000).toISOString(), updated_at: new Date(Date.now() - 172800000).toISOString(), author: { username: 'fatih_climb', avatar_url: null }, sector: { name: 'Ana Duvar' } },
  { id: 't5', title: 'Sol Kanat taş temizliği', content: '', author_id: 'u6', sector_id: '3', type: 'discussion', status: 'approved', is_pinned: false, approved_by: 'admin', approved_at: new Date(Date.now() - 259200000).toISOString(), created_at: new Date(Date.now() - 259200000).toISOString(), updated_at: new Date(Date.now() - 259200000).toISOString(), author: { username: 'ayse_kaya', avatar_url: null }, sector: { name: 'Sol Kanat' } },
]
